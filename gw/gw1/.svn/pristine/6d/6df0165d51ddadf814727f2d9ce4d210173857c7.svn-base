...
INSERT INTO `dede_addonarticle` VALUES ('13', '3', '将企业信息、服务、活动等内容通过微信网页的方式进行表现，用户通过简单的设置，就能生成微信3G网站。通过微信公众平台将企业品牌展示给微信用户，减少 宣传成本，建立企业与消费者、客户的一对一互动和沟通，将消费者接入企业CRM系统，进行促销、推广、宣传、售后等。形成了一种主流的线上线下微信互动营 销方式。', '', '', '0.0.0.0');
...
-- ----------------------------
INSERT INTO `dede_admin` VALUES ('1', '10', 'admin', '4ac51f7e0f38ba6ed359', 'admin', '', '', '', '1443538433', '127.0.0.1');
...
-- ----------------------------
INSERT INTO `dede_archives` VALUES ('1', '1', '0', '1436767700', 'h,p', '1', '1', '0', '151', '0', '痛点不痛的社区O2O解决什么问题？', '', '', 'admin', '未知', '/uploads/allimg/150713/121449EA-0-lp.jpg', '1436767700', '1436686055', '1', '扬,和,宏,科技,好弓,塞啊,的,厉害,', '0', '0', '0', '0', '0', '0', '好弓塞啊的 厉害', '', '1', '0', '0', '0');
INSERT INTO `dede_archives` VALUES ('2', '1', '0', '1436767678', 'h,p', '1', '1', '0', '189', '0', '传统企业转型互联网的十大死法', '', '', 'admin', '未知', '/uploads/allimg/150713/1214195191-0-lp.jpg', '1436767678', '1436691397', '1', '测试,新闻,好的,啊,大调,', '0', '0', '0', '0', '0', '0', '好的啊 D大调', '', '1', '0', '0', '1');
...
INSERT INTO `dede_archives` VALUES ('5', '4', '0', '1436760548', 'p', '1', '1', '0', '125', '0', '解读冰桶算法：只有优质资源能稳守宝座？', '', '', 'admin', '未知', '', '1436760548', '1436693553', '1', '资质,你,好啊,呵,呵呵,后,', '0', '0', '0', '0', '0', '0', '订单', '', '1', '0', '0', '4');
...
INSERT INTO `dede_archives` VALUES ('11', '5', '0', '1436760395', 'p', '1', '1', '0', '91', '0', '十三个细节 他做到了极致口碑营销', '', '', 'admin', '未知', '/uploads/allimg/150713/120F514D-0-lp.jpg', '1436760395', '1436760425', '1', '十三个,细节,他做,到了,极致,口碑,营销,本来,', '0', '0', '0', '0', '0', '0', '本来这篇文章应该早就写出来了，由于自己近期事情比较忙，所以也没及时整理写作出来！昨天算是有空档期了，然后我把我的感受和想法给大家说一下。 前段时间女朋友去了一家火锅', '', '1', '0', '0', '8');
...
INSERT INTO `dede_archives` VALUES ('12', '3', '0', '1436767788', 'p', '1', '1', '0', '179', '0', '电子商务网站建设', '', '', 'admin', '未知', '/uploads/allimg/150713/1-150G31410190-L.jpg', '1436767788', '1436767832', '1', '电子商务,网站建设,随着,网络,的,普及,程度,', '0', '0', '0', '0', '0', '0', '随着网络的普及程度的提高，消费者网络购物习惯的形成，电子商务已经成为企业的主要销售模式之一，电子商务也成为了一种新的创业模式。对于整个市场来说，这种新型的购物模式', '', '1', '0', '0', '9');
INSERT INTO `dede_archives` VALUES ('13', '3', '0', '1436767836', 'p', '1', '1', '0', '55', '0', '微信项目开发', '', '', 'admin', '未知', '/uploads/allimg/150713/1-150G31410590-L.jpg', '1436767836', '1436767864', '1', '微信,项目开发,将,企业信息,、,服务,活动,', '0', '0', '0', '0', '0', '0', '将企业信息、服务、活动等内容通过微信网页的方式进行表现，用户通过简单的设置，就能生成微信3G网站。通过微信公众平台将企业品牌展示给微信用户，减少 宣传成本，建立企业与', '', '1', '0', '0', '10');
...
INSERT INTO `dede_arctiny` VALUES ('13', '3', '0', '0', '1', '1436767864', '1436767836', '1');
...
-- ----------------------------
INSERT INTO `dede_arctype` VALUES ('1', '0', '0', '1', '公司新闻', '{cmspath}/a/gongsixinwen', '1', 'index.html', '1', '1', '-1', '0', '0', '{style}/index_article.htm', '{style}/xinwen.htm', '{style}/nr_xw.htm', '{typedir}/{Y}/{M}{D}/{aid}.html', '{typedir}/list_{tid}_{page}.html', 'default', '', '', '', '0', '{cmspath}/a/gongsixinwen', '', '0', '0', '', '&nbsp;', '');
INSERT INTO `dede_arctype` VALUES ('2', '0', '0', '6', '关于我们', '{cmspath}/a/guanyuwomen', '1', 'index.html', '1', '1', '-1', '1', '0', '{style}/about.htm', '{style}/list_article.htm', '{style}/article_article.htm', '{typedir}/{Y}/{M}{D}/{aid}.html', '{typedir}/list_{tid}_{page}.html', 'default', '', '', '', '0', '{cmspath}/a/guanyuwomen', '', '0', '0', '', '我们是一家年轻的互联网公司（深圳市扬和宏科技有限公司），我们是一支拥有丰富互联网经验和线下经验的创业团队。我们的小伙伴均来自知名电商、软件等各个行业。我们崇尚自由，思想开放；我们关注用户，追求完美；我们充满激情，迎难而上。\r\n<p>\r\n	对技术的热情和对商业的敏锐确保了扬和宏科技在客户预算范围内，按时提交高质量的产品和服务并同时满足客户对业务和技术两方面的需求。扬和宏科技致力于通过提供全球符合质量和安全标准的ITO和BPO服务来改善客户的业务绩效。</p>\r\n<p>\r\n	与扬和宏科技合作，您就拥有了一个经验丰富、技术精湛的合作伙伴，可帮助您提高软件解决方案的质量，缩短软件开发时间并降低软件开发成本。我们承诺你的商业价值。</p>\r\n<p>\r\n	因为有责任，因此有了扬和宏科技！<br />\r\n	因为有梦想，我们一直在奋斗！<br />\r\n	因为有激情，我们更加努力！<br />\r\n	扬和宏科技正在成长，希望您一路相伴！</p>\r\n', '');
INSERT INTO `dede_arctype` VALUES ('3', '0', '0', '2', '产品介绍', '{cmspath}/a/chanpinjieshao', '1', 'index.html', '1', '1', '-1', '0', '0', '{style}/index_article.htm', '{style}/tuleibiao.htm', '{style}/nr_tu.htm', '{typedir}/{Y}/{M}{D}/{aid}.html', '{typedir}/list_{tid}_{page}.html', 'default', '', '', '', '0', '{cmspath}/a/chanpinjieshao', '', '0', '0', '', '&nbsp;', '');
INSERT INTO `dede_arctype` VALUES ('4', '0', '0', '3', '解决方案', '{cmspath}/a/jiejuefangan', '1', 'index.html', '1', '1', '-1', '0', '0', '{style}/index_article.htm', '{style}/zizhi.htm', '{style}/nr_zz.htm', '{typedir}/{Y}/{M}{D}/{aid}.html', '{typedir}/list_{tid}_{page}.html', 'default', '', '', '', '0', '{cmspath}/a/jiejuefangan', '', '0', '0', '', '&nbsp;', '');
INSERT INTO `dede_arctype` VALUES ('5', '0', '0', '4', '通知公告', '{cmspath}/a/tongzhigonggao', '1', 'index.html', '1', '1', '-1', '0', '0', '{style}/index_article.htm', '{style}/xiangmu.htm', '{style}/nr_xm.htm', '{typedir}/{Y}/{M}{D}/{aid}.html', '{typedir}/list_{tid}_{page}.html', 'default', '', '', '', '0', '{cmspath}/a/tongzhigonggao', '', '0', '0', '', '&nbsp;', '');
INSERT INTO `dede_arctype` VALUES ('11', '0', '0', '5', '人才招聘', '{cmspath}/a/rencaizhaopin', '1', 'index.html', '1', '1', '-1', '1', '0', '{style}/hr.htm', '{style}/hr.htm', '{style}/hr.htm', '{typedir}/{Y}/{M}{D}/{aid}.html', '{typedir}/list_{tid}_{page}.html', 'default', '', '', '', '0', '{cmspath}/a/rencaizhaopin', '', '0', '0', '', '<div class=\"job-title\">\r\n	<span style=\"font-size:14px;\"><strong>产品总监</strong></span></div>\r\n<p>\r\n	<span style=\"font-size:14px;\">招聘人数：1人<br />\r\n	薪酬待遇：30k-80k<br />\r\n	岗位职责：<br />\r\n	1、根据公司和产品发展策略，制定所负责产品线的发展和实施计划；<br />\r\n	2、负责管理来自用户和公司内部的业务需求，完成需求分析，并最终形成产品设计；<br />\r\n	3、负责编写产品需求书、产品原型，协助开发团队理解和掌握需求，对产品需求方向和易用性负责；<br />\r\n	4、负责产品开发项目周期和进度把控，确保对产品开发至最终上线运营，对进度质量负责；<br />\r\n	5、负责跨部门协调和沟通，推动UI、开发、测试、运营等人员紧密合作达成产品目标；<br />\r\n	6、协调产品上线前的产品文档整理，商务推广，市场宣传等配合工作；<br />\r\n	7、研究市场和用户需求，不断优化产品，提升用户体验及活跃度，同时策划有竞争力的产品；<br />\r\n	8、管理产品团队，负责团队成员的工作任务分配和监督执行。</span></p>\r\n', '');
INSERT INTO `dede_arctype` VALUES ('8', '0', '0', '7', '联系我们', '{cmspath}/a/lianxiwomen', '1', 'index.html', '1', '1', '-1', '1', '0', '{style}/me.htm', '{style}/me.htm', '{style}/me.htm', '{typedir}/{Y}/{M}{D}/{aid}.html', '{typedir}/list_{tid}_{page}.html', 'default', '', '', '', '0', '{cmspath}/a/lianxiwomen', '', '0', '0', '', '<span style=\"display:block;margin:0px 0px 10px;line-height: 24px; font-family: Verdana; color: rgb(78,130,191); font-size: 16px; font-weight: bold\">公司地址</span>\r\n<p>\r\n	深圳市扬和宏科技有限公司<br />\r\n	地址：广东省深圳市宝安区西乡街道河东51401<br />\r\n	电话：18617072406<br />\r\n	邮箱：503717513@qq.com<br />\r\n	<br />\r\n	<span id=\"002\" name=\"002\" style=\"display:block;margin:20px 0px 10px;line-height: 24px; font-family: Verdana; color: rgb(78,130,191); font-size: 16px; font-weight: bold\">公司地图</span><br />\r\n	&nbsp;</p>\r\n<iframe frameborder=\"0\" height=\"815\" marginheight=\"0\" marginwidth=\"0\" scrolling=\"no\" src=\"http://j.map.baidu.com/Qdpt0\" width=\"604\"></iframe>', '');
INSERT INTO `dede_arctype` VALUES ('12', '0', '0', '50', '帮助中心', '{cmspath}/a/bangzhuzhongxin', '1', 'index.html', '1', '1', '-1', '1', '0', '{style}/help.htm', '{style}/list_article.htm', '{style}/article_article.htm', '{typedir}/{Y}/{M}{D}/{aid}.html', '{typedir}/list_{tid}_{page}.html', 'default', '', '', '', '0', '', '', '1', '0', '', '网站如发现问题，请联系www.webyang.net', '');
...
-- ----------------------------
INSERT INTO `dede_homepageset` VALUES ('youqi/index.htm', '../index.html', '0');
...
-- ----------------------------
INSERT INTO `dede_member` VALUES ('1', '个人', 'admin', '556aa4ac51f7e0f38ba6ed359432a440', 'admin', '男', '100', '0', '0', '0', '', '10000', '10', '0', '', '0', '', '1436685357', '', '1443538433', '127.0.0.1', '-1');
...
INSERT INTO `dede_plus_seoinfo` VALUES ('6', '1443450409', '0', '0', '0', '76,265', '0');
INSERT INTO `dede_plus_seoinfo` VALUES ('7', '1443531532', '0', '0', '0', '76,265', '0');
...
INSERT INTO `dede_sysconfig` VALUES ('24', 'cfg_df_style', '模板默认风格', '1', 'string', 'youqi');
