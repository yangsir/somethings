...
(function($)
		  {$.fn.kwicks=function(n){
			  var p={isVertical:false,sticky:false,defaultKwick:0,event:'mouseover',spacing:0,duration:600};
			  var o=$.extend(p,n);
			  var q=(o.isVertical?'height':'width');
			  var r=(o.isVertical?'top':'right');
			  return this.each(function(){
					...
					if(o.isVertical){
						...
						container.css({
							width:160+'px',height:k.eq(0).css('height')
						})
					}
					var m=[];
					for(i=0;i<k.size();i++){
					...
					k.each(function(i){
						...
						h.css({margin:0,position:''});
						h.bind(o.event,function(){setTab4('pre4',this.id.substring(6,7)-1,'2');
							var c=[];
							var d=[];
