<?php
$cfg_basehost = 'http://ny1985.92game.net';
$cfg_cmspath = '';
$cfg_cookie_encode = 'DmSCk1214I';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '模特天使网';
$cfg_webname = '美女_美女图片_性感美女_mm_丝袜美女_清纯美女_美女模特---92Game.Net';
$cfg_adminemail = 'admin@dedecms.com';
$cfg_html_editor = 'ckeditor';
$cfg_arcdir = '/a';
$cfg_medias_dir = '/uploads';
$cfg_ddimg_width = 180;
$cfg_ddimg_height = 250;
$cfg_domain_cookie = '';
...
$cfg_fck_xhtml = 'N';
$cfg_df_style = '92gamenet9ccbc6285gd978c1t';
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright@2010-2012 www.92Game.Net 版权所有 粤ICP备09197178号';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_basehostby = 'ny1985.92game.net';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '美女,模特网,美女图片,mm,丝袜美女,性感模特,内衣美女,性感美女图片';
$cfg_description = '美女模特,是网上知名美女图片,丝袜美女图片,性感美女图片,丝袜美女,美女诱惑,内衣美女,内衣秀,性感模特,明星模特,美女模特,非主流美女,美女写真图片库,mm网站互动平台,旗下拥有更多性感模特、性感美女、丝袜美女控、内衣秀、性感美女图片、丝袜美女图片、mm图片,丝袜美腿图片及美女图片资讯,是国内知名非盈利性感美女与丝袜美女内衣秀图片信息资源网.';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
