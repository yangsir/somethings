...
function ShowMsg($msg, $gourl, $onlymsg=0, $limittime=0)
{
    ...
    else
    {
      ...
      function JumpUrl(){
        ...
        $rmsg .= "<div style='padding:6px;font-size:12px;border-bottom:1px solid #DADADA;background:#DBEEBD url({$GLOBALS['cfg_plus_dir']}/img/wbg.gif)';'><b>魔客吧 www.moke8.com 提示信息！</b></div>\");\r\n";
        ...
        if($onlymsg==0)
        {
            ...
            {
                $rmsg .= "<br /><a href='{$gourl}'>魔客吧提示您，如果你的浏览器没反应，请点击这里...</a>";
                $rmsg .= "<br/></div>\");\r\n";
