<?php defined('IN_IA') or exit('Access Denied');?><link type="text/css" rel="stylesheet" href="./resource/style/daterangepicker.css" />
...
<div class="navbar navbar-static-top">
	<div class="navbar-inner">
		...
		<div class="pull-left">
			<ul class="nav">
				<li <?php  if($_GPC['foo'] == 'hit' || empty($_GPC['foo'])) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('keyword', array('foo' => 'hit'))?>">已触发关键字</a></li>
				<li <?php  if($_GPC['foo'] == 'miss') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('keyword', array('foo' => 'miss'))?>">未触发关键字</a></li>
			</ul>
		</div>
	</div>
</div>
