...
<div class="navbar navbar-static-top">
	<div class="navbar-inner">
		...
		<div class="pull-left">
			<ul class="nav">
				<li <?php  if($_GPC['foo'] == 'hit' || empty($_GPC['foo'])) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('rule', array('foo' => 'hit'))?>">已触发规则</a></li>
				<li <?php  if($_GPC['foo'] == 'miss') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('rule', array('foo' => 'miss'))?>">未触发规则</a></li>
			</ul>
		</div>
	</div>
</div>
