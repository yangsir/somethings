					...
					<div class="sub-content">
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									<td class="row-hover"><?php  if(empty($row['rid'])) { ?>N/A<?php  } else { ?><a target="main" href="<?php  echo create_url('rule/post', array('id' => $row['rid']))?>"><?php  echo $rules[$row['rid']]['name'];?></a><?php  } ?></td>
