...
<footer>
		<a href="s.php?weid=<?php  echo $_W['weid'];?>&fname=<?php  echo urlencode($_W['fans']['from_user'])?>&title=<?php  echo urlencode($row['title'])?>&icon=<?php  echo urlencode($row['thumb'])?>&date=<?php  echo $t;?>&link=<?php  echo urlencode($this->createMobileUrl('detail', array('name' => 'detail', 'id' => $row['id'], 'weid' => $_W['weid'])))?>&&source=<?php  echo urlencode($row['source'])?>"><img src="img/i_s.png" width="24" height="24" />收藏</a>
</footer>
